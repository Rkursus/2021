...
# Loe sisse andmestik
mass <- read.table("https://github.com/Rkursus/2020/raw/master/data/mass.txt", sep = "\t", header =
                     TRUE)
library(stringr)
...
visiidid <- read.table("https://github.com/Rkursus/2020/raw/master/data/visiidid.txt", sep = "\t",
                       header = TRUE)
head(visiidid)
...
visiidid <- read.table("https://github.com/Rkursus/2020/raw/master/data/visiidid.txt", sep = "\t", header = TRUE)
head(visiidid)
